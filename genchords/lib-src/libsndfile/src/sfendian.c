...
*/
   ...
   void
   endswap_short_array2 (short *ptr, int len)
   {
   ...
   void
   endswap_int_array2 (int *ptr, int len)
   {
   #if 0
	   unsigned char *ucptr, temp ;
...
*/
...
#ifndef WIN32 //vvv for compatibility with MSVC++ 6 compiler
   void
   endswap_short_copy2 (short *dest, short *src, int len)
   {
   #if	0
	   char *psrc, *pdest ;
   ...
   void
   endswap_int_copy2 (int *dest, int *src, int len)
   {
   #if	0
	   char *psrc, *pdest ;
